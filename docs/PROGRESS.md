...
- MIT licence (Copyright 2026 ren) added for project code, package metadata, README and fixed public `/license`. Dependencies keep their licences. Deployer ToS states source-only, auditable, AS IS, limited liability subject to mandatory law; no public repository or security-certification claim.
